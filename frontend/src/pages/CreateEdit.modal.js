...
class CreateEditModal extends PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.info) this.setState({ ...nextProps.info });
  }
  ...
  setDialogTitle() {
    ...
    else if (type === TYPE.comment) return "New Comment";
          ...
          <form autoComplete="off" onSubmit={this.onSubmit}>
            ...
            <DialogActions>
              ...
              <Button
                type="submit"
                disabled={
                  type === TYPE.post && this.state.category.length === 0
                }
                color="primary"
              >
                Save
